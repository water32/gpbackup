...
func RetrieveAndProcessTables() ([]Table, []Table, map[Relation]int) {
	...
	workerTableIndex := LockTables(connectionPool, tableRelations)
	...
	return metadataTables, dataTables, workerTableIndex
}
